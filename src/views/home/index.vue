<template>
  <el-container id="home">
    ...
    <el-aside class="my-aside">
      <!-- 左侧container -->
      <el-container class="left-cont">
        <!-- 左侧栏header -->
        <el-header class="left-cont-head">
          <img
    ...
    <el-main class="my-main">
      <!-- 右container -->
      <el-container class="my-main-cont">
        <!-- container头部 -->
        <el-header class="my-main-head">
  ...
  methods: {
    ...
    handleCommand(command) {
      if (command == "logout") {
        ...
        // git地址
        window.open("https://17752877748.github.io/#");
      }
    }
  },
  created() {
